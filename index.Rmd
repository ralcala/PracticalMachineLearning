...
As a final step, we check the variables ofr near zero variance with an apropiate caret function, but no one was found after removing the columns with high number of missing values.
...
data.frame(table(round(na_prop, 3)))
...
#rm(col_bookeeping, col_remove, col_zero_var, na_prop)
```
